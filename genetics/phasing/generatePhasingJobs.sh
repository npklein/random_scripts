...
shapeit \\
 -call \\
 --input-gen /groups/umcg-bios/tmp03/projects/genotypes_BIOS_LLDeep_Diagnostics_merged_phasing/results/beagle//genotypes_BIOSfreeze2.1_LLDeep_Diagnostics_merged.chr$CHR.beagle.genotype.probs.gg.gen.gz \\
             /groups/umcg-bios/tmp03/projects/genotypes_BIOS_LLDeep_Diagnostics_merged_phasing/results/beagle//genotypes_BIOSfreeze2.1_LLDeep_Diagnostics_merged.chr$CHR.beagle.genotype.probs.gg.gen.sample \\
 --input-init /groups/umcg-bios/tmp03/projects/genotypes_BIOS_LLDeep_Diagnostics_merged_phasing/results/beagle/genotypes_BIOSfreeze2.1_LLDeep_Diagnostics_merged.chr$CHR.beagle.genotype.probs.gg.hap.gz \\
              /groups/umcg-bios/tmp03/projects/genotypes_BIOS_LLDeep_Diagnostics_merged_phasing/results/beagle/genotypes_BIOSfreeze2.1_LLDeep_Diagnostics_merged.chr$CHR.beagle.genotype.probs.gg.hap.sample \\
 ...
 bname=\$(basename $RESULTSDIR/genotypes_BIOS_LLDeep_Diagnostics_merged.chr$CHR.$START.$END.shapeit.phased.hap.gz.sample)
 md5sum \${bname} > \${bname}.md5

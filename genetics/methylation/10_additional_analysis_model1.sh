...
time R --vanilla << "EOF"
path.out="/groups/umcg-lld/tmp03/umcg-ndeklein/EWAS/output/extra_analysis/model1/"
dir.create(file.path("/groups/umcg-lld/tmp03/umcg-ndeklein/EWAS/output/", "extra_analysis/"))
dir.create(file.path("/groups/umcg-lld/tmp03/umcg-ndeklein/EWAS/output/extra_analysis/", "model1"))
print(path.out)
...
for(cpg in cpgs_to_test){
    ...
    out <- paste0(path.out,cpg,'_model1_LLD_',d,'.txt')
